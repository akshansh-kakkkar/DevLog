...
export default function Page() {
  ...
  const [pagentaion, setPagentaion] = useState({
    currentPages: 1,
    totalPages: 1,
    titalPosts: 0,
  });
  ...
  return (
    <div className="mt-12 mx-5 md:mx-12 lg:mx-22 flex gap-7 flex-col">
      ...
      <div className="bg-white border border-[#C6C6CD] rounded-md  py-6">
        <div className="flex px-6 pb-6 justify-between items-center">
          <div
            className={`text-3xl text-[#191C1E] ${geist.className} font-semibold`}
          >
            Recent Articles
          </div>
        ...
        <div
          className={`p-6 flex items-center font-medium justify-between bg-[#F2F4F6] border-y border-[#C6C6CD] ${jetbrains.className} text-[#45464D]`}
        >
          <div>Post Title</div>
        ...
        {posts.map((post) => (
          ...
          >
            ...
            <div className="flex gap-32">
              ...
              <div className={`text-[#45464D] ${geist.className} text-sm`}>{new Date(post.createdAt).toLocaleDateString()}</div>
